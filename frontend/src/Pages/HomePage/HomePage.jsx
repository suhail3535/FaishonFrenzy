...
function HomePage() {
    return (
        <div style={{ maxWidth: "95vw", margin: "auto" }} className="main-home-div">
            <SimpleGrid
                columns={[1, 2, 2, 4]}
                spacing="3px"
            ...
            <SimpleGrid columns={[1, null, 3]} gap={5} className={styles.paddinLeft}>
                <Flex direction={"column"} gap={5}>
                    ...
                    <Text textAlign={"start"}>
                        Turn to the experts in flattering fits and flawlessly tailored pairs
                        to start spring on the right note.
                    </Text>
