    ...
    return (
        < >
            <SimpleGrid columns={[1, 2, 2, 4]} spacing='3px' className={styles.paddinLeft} paddingTop={"30px"} paddingBottom={"30px"}>
                ...
                <GridItem>
                    <Image w={"100%"} src="https://images.ctfassets.net/5de70he6op10/1NPjQQ97u8xeHrFHkXjrax/8e715eaa8cf02c6c9daba8dadd4b2d6a/LS_M0_Banner_b.jpg?w=630&q=80&fm=webp" alt="Error" />
                </GridItem>
                 
                <GridItem>
                    <Image w={"100%"} src="https://images.ctfassets.net/5de70he6op10/1Lyxv82WJDkGaRWROJFSL3/d2a3f0c2dcfc706a09c4b7991b43f67d/LS_M0_Banner_f.jpg?w=630&q=80&fm=webp" alt="Error" />
                </GridItem>

                <GridItem>
                    <Image w={"100%"} src="https://images.ctfassets.net/5de70he6op10/5NZtjeqhlhchOW8aK8ALjQ/b50f60cb0cdcdaf3e1878c13aaea7907/LS_M0_Banner_e.jpg?w=630&q=80&fm=webp" alt="Error" />
                </GridItem>
            </SimpleGrid>
            ...
            <SimpleGrid columns={[1, 2, 4]} spacing='40px' marginTop={"30px"} className={styles.paddinLeft}>
                <Box>
                    <Image src="https://images.ctfassets.net/5de70he6op10/3oxEDi87p07u8PDBRUWZQT/799ee882cf52081f2d78dd8d9f4dcc62/484733075-ls_m2a.jpg?w=660&q=80&fm=webp" alt="Error" />
                </Box>

                <Box>
                    <Image src="https://images.ctfassets.net/5de70he6op10/7FFfT0oq4tbFutP6p7u4YZ/71fb0faac0ef301451d157e0b035f8a0/484733081-ls_m2b.jpg?w=660&q=80&fm=webp" alt="Error" />
                </Box>

                <Box>
                    <Image src="https://images.ctfassets.net/5de70he6op10/55I6Ziwm1BLgmFHzuRJi9U/d5afd53ea4e04c32444f7e6994de3a26/484733090-ls_m2c.jpg?w=660&q=80&fm=webp" alt="Error" />
                </Box>

                <Box>
                    <Image src="https://images.ctfassets.net/5de70he6op10/6m0is55tRAh4uMrxrsZwyb/5d42159121116c07584fca7d41dc5ac2/484733095-ls_m2d.jpg?w=660&q=80&fm=webp" alt="Error" />
                </Box>
            ...
            <Flex columns={[1,1,2]} gap={"25px"} marginTop={"35px"} className={styles.paddinLeft}>
                {/* <GridItem width={"160%"} > */}
                    <Image h={"620px"}width={"50%"}  src="https://images.ctfassets.net/5de70he6op10/7cxMotLF5i9rrL92ndmypR/88e8ae5aa03038acc259dd104a9d2963/484733176-ls_m4a.jpg?w=1302&q=80&fm=webp" alt={"error"} />
                   
                {/* </GridItem> */}
                {/* <GridItem > */}
                <Image h={"620px"}width={"50%"} src="https://images.ctfassets.net/5de70he6op10/716Ut6ZHZcpObdM9yRjLX8/ceb76d3813b83c516a7773b4749d9dcd/484733181-ls_m4b.jpg?w=1302&q=80&fm=webp" alt={"error"} />
                {/* </GridItem> */}
            </Flex>
            ...
            <Image width={"98.5%"} marginTop={"30px"} className={styles.paddinLeft} src={"https://images.ctfassets.net/5de70he6op10/2XUxhNlu24HaHTFRAghRS3/f30d5364574fc72b718e910f087b2685/484733194-ls_m5a.jpg?w=2640&q=80&fm=webp"} alt="error"/>
            ...
            <Box className={styles.paddinLeft} marginTop={10}>
                <Text fontFamily={"Spectral Extra Light serif"} fontSize={22} textAlign={"start"}>
            ...
            <Box className={styles.paddinLeft} marginTop={10}>
                <Text fontFamily={"Spectral Extra Light serif"} fontSize={22} textAlign={"center"}>
